...
public class ChessMatch {
	...
	public void initialSetUp() {
		...
		newPlacePiece('d', 1, new Rook(board, Color.WHITE));
		newPlacePiece('f', 1, new Rook(board, Color.WHITE));
		newPlacePiece('d', 2, new Rook(board, Color.WHITE));
		newPlacePiece('e', 2, new Rook(board, Color.WHITE));
		newPlacePiece('f', 2, new Rook(board, Color.WHITE));
